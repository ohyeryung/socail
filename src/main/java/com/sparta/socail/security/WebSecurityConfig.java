package com.sparta.socail.security;

import com.sparta.socail.security.filter.FormLoginFilter;
import com.sparta.socail.security.filter.JwtAuthFilter;
import com.sparta.socail.security.jwt.HeaderTokenExtractor;
import com.sparta.socail.security.provider.FormLoginAuthProvider;
import com.sparta.socail.security.provider.JWTAuthProvider;
...
//        corsConfiguration.addAllowedOrigin("http://localhost:3000"); // local 테스트 시
        corsConfiguration.addAllowedOrigin("http://hanghae99coneproject.s3-website.ap-northeast-2.amazonaws.com/"); //배포시
